// app/packages/go-to-market-strategy/page.tsx
'use client';
...
const BookingModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  const basePrice = 40000; // ₹40,000 as example - adjust based on your pricing
    ...
    try {
      ...
      const response = await fetch('/api/validate-coupon', {
        ...
        body: JSON.stringify({ 
          ...
          packageId: 'go-to-market-strategy'
        })
      });
  ...
  const initiateRazorpayPayment = (orderId: string) => {
    const options: RazorpayOptions = {
      ...
      currency: 'INR',
      name: 'Sarsen & Company',
      description: 'Go-To-Market Strategy Package',
      order_id: orderId,
      ...
      <div className="bg-white max-w-2xl w-full rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between z-10">
          <h2 className="text-2xl font-semibold text-gray-900">
            {step === 'form' && 'Book Your GTM Strategy'}
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="product-built">Product built, struggling with sales</option>
                <option value="inconsistent-sales">Inconsistent sales performance</option>
            ...
            <div>
              ...
              >
                ...
                <option value="inconsistent-sales">Inconsistent or unpredictable sales</option>
                <option value="channel-selection">Which channels should we focus on?</option>
                <option value="founder-led-sales">Stuck in founder-led sales mode</option>
                <option value="funnel-leakage">High funnel leakage and drop-offs</option>
                <option value="pricing-packaging">Unsure about pricing and packaging</option>
                <option value="scaling-acquisition">How to scale customer acquisition</option>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-left">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
                  ...
                  <span>Our team will contact you within 24 hours to schedule your GTM Context & Objective Session</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span>You'll receive data preparation guidelines for funnel and channel analysis</span>
                </li>
                <li className="flex items-start gap-2">
                  <svg className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="max-w-4xl">
          ...
          <p className="text-xl sm:text-2xl text-blue-200 font-light leading-relaxed mb-8 max-w-3xl">
            Build a repeatable and scalable customer acquisition system. Designed for startups with a product but inconsistent sales.
          </p>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-l-4 border-blue-500 rounded-xl p-8 sm:p-10 lg:p-12">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Startups with a product but inconsistent sales. If you've built a product but struggle with predictable customer acquisition, are stuck in founder-led sales mode, or have high funnel leakage, this package provides the structured approach to build a repeatable GTM machine.
          </p>
        </div>
      </div>
    </section>
...
const CoreServices = () => {
  const services = [
    {
      number: "01",
      title: "GTM Channel Universe Mapping",
      description: "Comprehensive mapping of all potential customer acquisition channels relevant to your business."
    },
    {
      number: "02",
      title: "Channel Prioritisation & Focus Logic",
      description: "Framework to prioritize channels based on cost, scalability, and strategic fit."
    },
    {
      number: "03",
      title: "Sales Motion Definition",
      description: "Clarity on founder-led vs team-led sales, and appropriate sales processes for each stage."
    },
    {
      number: "04",
      title: "Funnel Structure & Leakage Diagnosis",
      description: "Analysis of your sales funnel to identify leaks, drop-offs, and optimization opportunities."
    },
    {
      number: "05",
      title: "Core Messaging & Positioning Logic",
      description: "Development of compelling messaging that resonates with target customers."
    },
    {
      number: "06",
      title: "Pricing & Packaging Sanity Check",
      description: "Evaluation of current pricing strategy and recommendations for optimization."
    },
    {
      number: "07",
      title: "90-Day GTM Execution Planning",
      description: "Detailed 90-day execution plan with specific actions, milestones, and metrics."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl leading-relaxed">
            This package includes 7 mandatory core services that form the foundation of effective go-to-market strategy.
          </p>
        </div>
...
const FlexibleServices = () => {
  const services = [
    {
      number: "F1",
      title: "CAC Logic & Payback Analysis",
      description: "Analysis of Customer Acquisition Cost and payback period across channels."
    },
    {
      number: "F2",
      title: "Pilot Channel Experiment Design",
      description: "Design of controlled experiments to test new acquisition channels."
    },
    {
      number: "F3",
      title: "Partner GTM Feasibility Assessment",
      description: "Evaluation of partnership opportunities for customer acquisition."
    },
    {
      number: "F4",
      title: "Geo-Market Entry Logic",
      description: "Framework for geographical expansion and market entry prioritization."
    },
    {
      number: "F5",
      title: "Sales Process & CRM Logic Review",
      description: "Assessment and recommendations for sales process and CRM implementation."
    }
  ];
    ...
    <section className="bg-[#E8EEF2] py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl leading-relaxed">
            Select 3 additional services to tailor the package to your specific GTM challenges.
          </p>
        </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-blue-800 text-sm">
                You can choose up to 3 flexible services. These will be customized based on your specific GTM challenges and goals. Our team will help you select the most relevant options during the context session.
              </p>
            </div>
          </div>
        </div>
  ...
  const deliverables = [
    {
      ...
      description: "Comprehensive strategy covering channel prioritization, sales motion, messaging, pricing, and execution roadmap."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Funnel & Channel Sheets",
      description: "Detailed analysis of current funnel performance and channel-specific recommendations with metrics."
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Detailed execution plan with specific actions, responsibilities, milestones, and success metrics for next 90 days."
    }
  ];
    ...
    <section className="bg-white py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl leading-relaxed">
            Three actionable documents that provide a complete GTM blueprint for your business.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light text-white mb-6">
            Repeatable and focused customer acquisition system.
          </h2>
          <p className="text-xl text-blue-200 font-light leading-relaxed">
            You'll have a clear, executable plan to acquire customers predictably and scale your revenue engine.
          </p>
        </div>
      </div>
    </section>
...
const ImpactMeasurement = () => {
  const metrics = [
    {
      name: "CAC Clarity Index",
      description: "Measurement of understanding and optimization of Customer Acquisition Cost across channels."
    },
    {
      name: "Funnel Efficiency Score",
      description: "Quantitative assessment of sales funnel performance and conversion optimization opportunities."
    }
  ];
    ...
    <section className="bg-[#d4dce5] py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl leading-relaxed">
            We track the effectiveness of this package through two key GTM metrics.
          </p>
        </div>
...
const CustomerServiceRoadmap = () => {
  ...
  const roadmapSteps = [
    {
      number: "1",
      title: "GTM Context & Objective Session",
      description: "Initial session to understand your product, target market, current GTM efforts, and specific objectives for the engagement.",
      timing: "Week 1 • 60 minutes"
    },
    {
      number: "2",
      title: "Funnel & Channel Diagnostic",
      description: "Detailed analysis of current sales funnel, channel performance, customer acquisition costs, and conversion metrics.",
      timing: "Week 1"
    },
    {
      number: "3",
      title: "Strategy Design & Prioritisation",
      description: "Development of comprehensive GTM strategy including channel selection, sales motion, messaging, and pricing recommendations.",
      timing: "Internal Process"
    },
    {
      number: "4",
      title: "GTM Strategy Delivery Session",
      description: "90-minute session where we present the complete GTM strategy, discuss implementation approach, and align on priorities.",
      timing: "Week 2 • 90 minutes"
    },
    {
      number: "5",
      title: "Execution Plan Handover",
      description: "Delivery of all deliverables and detailed 90-day execution plan with specific actions, milestones, and success metrics.",
    ...
    <section className="bg-white py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 sm:mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl leading-relaxed">
            A structured 2-week journey designed to build a repeatable GTM system.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 sm:p-10 lg:p-12 border-2 border-gray-200">
          ...
          <div className="max-w-2xl mx-auto mb-10">
            <ul className="space-y-4">
              {[
                "7 core GTM strategy services",
                "3 customizable flexible services (choose from 5 options)",
                "3 comprehensive deliverable documents",
                "GTM Strategy Document with complete blueprint",
                "Funnel & Channel Sheets with analysis",
                "90-Day GTM Execution Plan",
                "CAC Clarity Index measurement",
                "Funnel Efficiency Score assessment"
              ].map((feature, index) => (
...
const FAQSection = () => {
  ...
  const faqs = [
    {
      question: "How do you determine which channels to focus on?",
      answer: "We use a data-driven framework considering: 1) Channel-market fit (alignment with your ICP), 2) Cost efficiency and scalability, 3) Competitive landscape, 4) Your team's capabilities, and 5) Testing results from pilot experiments."
    },
    {
      question: "What if we don't have much sales data yet?",
      answer: "That's common for early-stage startups. We'll work with whatever data you have, supplement with industry benchmarks, and design experiments to gather the necessary data. The focus shifts to building a hypothesis-driven GTM approach rather than optimizing existing channels."
    },
    {
      question: "How do you help with founder-led to team-led sales transition?",
      answer: "We provide a structured framework for documenting founder sales processes, identifying bottlenecks, designing scalable processes, and creating hiring plans for sales roles. We also help with CRM selection and implementation guidance."
    },
    {
      question: "Can this package help with pricing strategy?",
      answer: "Yes, pricing and packaging sanity check is a core service. We analyze your current pricing, compare with competitors and value delivered, and provide recommendations for optimization. We can also include willingness-to-pay analysis as a flexible service."
    },
    {
      question: "How soon will we see results from implementing the GTM strategy?",
      answer: "Some improvements (like messaging optimization) can show results in weeks. Channel testing and scaling typically takes 3-6 months. The 90-day plan focuses on quick wins while building foundation for longer-term scaling."
    },
    {
      question: "What's the difference between this and Package 2 (PMF)?",
      answer: "Package 2 focuses on product-market fit: 'Are we building the right product for the right market?' Package 3 focuses on go-to-market: 'How do we systematically acquire customers for this product?' PMF comes first, then GTM."
    }
  ];
    ...
    <section className="bg-[#0A1E3D] py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl text-blue-200 font-light mb-10">
          Start with the Go-To-Market Strategy Package
        </p>
