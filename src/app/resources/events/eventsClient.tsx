...
export const ServiceModularPackagesHero = () => (
  <ResourceHeroShell devLabel="">
    <ResourceHeroGrid
      heading="Bringing the Industry Together."
      sub="Focused Conversations Bringing together Leaders, Operators, Experts, and Partners around the Forces Shaping a Specific Industry or Domain."
...
export default function EventsClient(): React.JSX.Element {
