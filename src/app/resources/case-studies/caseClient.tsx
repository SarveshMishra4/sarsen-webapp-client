// app/case-studies/caseStudiesClient.tsx
'use client';
...
export const ServiceModularPackagesHero = () => (
  <ResourceHeroShell devLabel="">
    <ResourceHeroGrid
      ...
      sub="Real Engagements. Real Business Situations. and the Strategic Work Behind Them. Names and Certain Details may be Changed to Preserve confidentiality."
...
export default function CaseStudiesClient(): React.JSX.Element {
