...
export const ServiceModularPackagesHero = () => (
  <ResourceHeroShell devLabel="">
    <ResourceHeroGrid
      heading="Tools Built for the Field."
      sub="Practical Tools for Operators, Founders, and Investors to Analyse Businesses, Uncover Opportunities, Test Assumptions, and Build for Growth."
...
// =====================================================
// TAG FILTER BAR — blue palette, fixed clipping
// =====================================================
...
// =====================================================
// PAGE ROOT COMPONENT (renamed from ToolsHubPage to ToolsClient)
// =====================================================

export default function ToolsClient(): React.JSX.Element {
