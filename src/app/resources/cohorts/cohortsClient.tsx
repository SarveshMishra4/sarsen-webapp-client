...
export const ServiceModularPackagesHero = () => (
  <ResourceHeroShell devLabel="">
    <ResourceHeroGrid
      heading="Build Together. Learn From the Field."
      sub="Focused Groups of Founders, Operators, Investors, and Founding Teams Working through Shared Challenges, Perspectives, and Opportunities."
