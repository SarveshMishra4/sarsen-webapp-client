...
import { BlogHeroSection } from '@/app/test/page';
import React, {
  useState,
  useRef,
  useEffect,
...
export const ServiceModularPackagesHero = () => (
  <ResourceHeroShell devLabel="">
    <ResourceHeroGrid
      heading="Research That Goes Deeper."
      sub="Research, Analysis, and Reports Examining Businesses, Industries, markets, and the Forces Shaping Them. Built from Evidence and Informed by Work across the Field."
...
// =====================================================
// PAGE ROOT COMPONENT (renamed from ReportsHubPage to ReportsClient)
// =====================================================
