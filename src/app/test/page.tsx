...
export const ResourceClosedLoopHero = () => (
  <ResourceHeroShell devLabel="Resources — Closed Loop">
    <ResourceHeroGrid
      heading="Before We Move Forward, We Come Full Circle."
      sub="Every recommendation is tested against itself before it goes out the door — the loop closes exactly where it started, then the work continues."
      right={<ClosedLoopDiagram />}
    />
  </ResourceHeroShell>
);
