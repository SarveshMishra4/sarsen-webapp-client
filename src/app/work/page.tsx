...
// own the route's metadata and hand off rendering to WorkClient.
import type { Metadata } from 'next';
import WorkClient from './workClient';

const BASE_URL = 'https://www.sarsenpartners.com';
const PAGE_URL = `${BASE_URL}/work`;
...
export const metadata: Metadata = {
  ...
  // so this renders as: "Work - Sarsen Strategy Partners"
  title: 'Work',

  // ── Description (Google's snippet, and OG/Twitter fallback) ────────────────
  description:
    'How Sarsen Strategy Partners works with founders — diagnostic-led, execution-focused, and structured to deliver clarity without dependency. Explore our engagement philosophy, process, and deliverables.',

  // ── Keywords — page-specific, not the homepage's generic list ─────────────
  keywords: [
    'how we work Sarsen Partners',
    'strategy consulting process',
    'founder engagement approach',
    'diagnostic-led consulting',
  ],
  ...
  openGraph: {
    ...
    title: 'Work - Sarsen Strategy Partners',
    description:
      'How Sarsen Strategy Partners works with founders — diagnostic-led, execution-focused, and structured to deliver clarity without dependency.',
    images: [
      {
        url: OG_IMAGE,
        width: 1200,
        height: 630,
        alt: 'Sarsen Strategy Partners — How We Work',
      },
    ],
  },
