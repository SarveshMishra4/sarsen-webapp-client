        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 md:p-12 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-600 ">
              By using our website or services, you acknowledge that you have reviewed and accept all of our collective legal documents.
            </p>
          </section>

          {/* Our Commitment */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">2. Our Commitment to Accessibility</h2>
            <p className="text-gray-600  mb-4">
              The Company is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying relevant accessibility standards to make our website and services as inclusive as reasonably possible.
            </p>
            <p className="text-gray-600  mb-4">
              Accessibility is an ongoing effort, and we are dedicated to making our digital presence usable by all individuals. However, we recognize that full accessibility may not always be achievable due to technological limitations, third‑party content, or evolving standards.
            </p>
          </section>

          {/* Accessibility Standards */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">3. Accessibility Standards</h2>
            <p className="text-gray-600  mb-4">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
              ...
              <li><strong>Section 508:</strong> We work toward compliance with Section 508 of the U.S. Rehabilitation Act for our U.S. clients.</li>
            ...
            <p className="text-gray-600 ">
              Conformance is an ongoing process, and while we strive to meet these standards, we do not guarantee that every element of our website or digital content will be fully compliant at all times.
            </p>
          </section>

          {/* Accessibility Features */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">4. Accessibility Features</h2>
            <p className="text-gray-600  mb-4">
              Our website includes the following accessibility features:
            </p>

            <h3 className="text-xl font-medium text-gray-800 mb-3">4.1 Visual Accessibility</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">4.2 Keyboard Navigation</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">4.3 Screen Reader Compatibility</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">4.4 Content and Media</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">4.5 Interactive Elements</h3>
          ...
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">5. Compatible Assistive Technologies</h2>
            <p className="text-gray-600  mb-4">
              Our website is designed to be compatible with the following assistive technologies:
            </p>
            
            <h3 className="text-xl font-medium text-gray-800 mb-3">5.1 Screen Readers</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">5.2 Browser and Platform Support</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">5.3 Additional Tools</h3>
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4">
          ...
          {/* Known Limitations */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">6. Known Limitations</h2>
            <p className="text-gray-600  mb-4">
              Despite our best efforts, some limitations may exist:
            </p>
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
              <li><strong>Third-Party Content:</strong> Some third-party embedded content (such as videos, maps, or widgets) may not be fully accessible. We are not responsible for the accessibility of third-party services, though we endeavor to work with providers to improve their accessibility.</li>
              <li><strong>PDF Documents:</strong> Some legacy PDF documents may not be fully accessible. We are in the process of remediating these documents or providing accessible alternatives upon request.</li>
            ...
            <p className="text-gray-600 ">
              If you encounter accessibility barriers with any of our content, please contact us, and we will work with you to provide an alternative or solution.
            </p>
          </section>

          {/* Ongoing Efforts */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">7. Ongoing Accessibility Efforts</h2>
            <p className="text-gray-600  mb-4">
          ...
          {/* Alternative Access */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">8. Alternative Access to Services</h2>
            <p className="text-gray-600  mb-4">
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
              <li><strong>Email Support:</strong> Contact us at accessibility@sarsen.com with your needs.</li>
              <li><strong>Video Consultations:</strong> Schedule accessible video consultations via email.</li>
              <li><strong>Alternative Formats:</strong> Request documents in alternative formats (large print, audio, etc.) where reasonably feasible.</li>
              <li><strong>Personalized Assistance:</strong> Work with our team to find accessible solutions for your specific needs.</li>
            </ul>
            <p className="text-gray-600 ">
              We will make reasonable efforts to accommodate requests, subject to the limitations set forth in our Terms of Use.
            </p>
          </section>

          {/* Feedback and Reporting */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">9. Feedback and Accessibility Issues</h2>
            <p className="text-gray-600  mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">9.1 How to Report Issues</h3>
            <p className="text-gray-600  mb-4">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">9.2 Response Timeline</h3>
            <p className="text-gray-600  mb-4">
            ...
            <p className="text-gray-600  mt-4">
              <strong>Note:</strong> The Company’s ability to resolve accessibility issues may be limited by the nature of the underlying technology or third‑party components. We will make reasonable efforts to provide alternative solutions where full remediation is not possible.
            </p>
          </section>

          {/* Legal Compliance */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">10. Legal and Regulatory Compliance</h2>
            <p className="text-gray-600  mb-4">
              The Company complies with applicable accessibility laws and regulations, including:
            </p>
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-4">
            ...
            <p className="text-gray-600 ">
              We recognize that accessibility is not only a legal requirement but also a commitment to inclusivity. However, compliance is measured by reasonable efforts and the availability of technology. The Company disclaims liability for any failure to meet these standards caused by factors beyond its control.
            </p>
          </section>

          {/* Third-Party Content */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">11. Third-Party Services and Content</h2>
            <p className="text-gray-600  mb-4">
            ...
            <p className="text-gray-600 ">
              While we strive to select accessible third-party services, we cannot control their accessibility features. If you experience issues with third-party content, please contact us, and we will work with you to find an accessible alternative or solution to the extent reasonably possible.
            </p>
          </section>

          {/* Contact Information */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">12. Contact Our Accessibility Team</h2>
            <p className="text-gray-600  mb-4">
              For accessibility-related questions, feedback, or to request assistance:
            </p>
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
              <p className="text-gray-800 font-medium mb-2">Accessibility Coordinator</p>
              <p className="text-gray-600 mb-2"><strong>Email:</strong> accessibility@sarsen.com</p>
          ...
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">13. Updates to This Statement</h2>
            <p className="text-gray-600 ">
              This Accessibility Statement was last updated on March 26, 2026. We review and update this statement regularly to reflect our ongoing accessibility improvements and changes to applicable standards. Please check back periodically for updates.
            </p>
          </section>

          {/* Formal Complaints */}
          <section>
            <h2 className="text-2xl font-medium text-gray-800 mb-4">14. Formal Complaints Process</h2>
            <p className="text-gray-600  mb-4">
            ...
            <ol className="list-decimal list-inside text-gray-600 space-y-3 ml-4 mb-4">
              <li className="">
                <strong>Internal Escalation:</strong> Request escalation to our senior management team by emailing legal@sarsen.com.
              </li>
              <li className="">
            ...
            <p className="text-gray-600 ">
              We are committed to working constructively with you to resolve any accessibility concerns, subject to our Terms of Use and the limitations set forth herein.
            </p>
          </section>
          ...
          <section className="bg-blue-50 rounded-lg p-6 border border-blue-100">
            ...
            <p className="text-gray-600 ">
              The Company is dedicated to making our digital presence accessible to all individuals. Accessibility is an ongoing journey, and we welcome your partnership in improving our services. By using our website and services, you acknowledge that you have read and understood this Accessibility Statement and agree to its terms, in conjunction with our other legal documents.
            </p>
          </section>
