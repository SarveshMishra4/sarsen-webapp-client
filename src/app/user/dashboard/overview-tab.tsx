        ...
        <div className="bg-white rounded-md p-6 shadow-sm border border-gray-200">
          ...
          <div className="space-y-3">
            {pendingQuestionnaires.slice(0, 3).map((q) => (
              <div key={q.id} className="p-4 bg-orange-50 rounded-md border border-orange-200">
          ...
          <div className="space-y-3">
            {resources.slice(0, 3).map((r) => (
              <div 
                ...
                className="p-4 bg-gray-50 rounded-md border border-gray-200 hover:bg-gray-100 cursor-pointer transition-colors"
              >
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 bg-gradient-to-br ${getFileColor(r.type)} rounded-md flex items-center justify-center text-white flex-shrink-0`}>
