...
interface ContainerProps {
  ...
  className?: string
  maxWidth?: 'sm' | 'md' | 'lg' | 'xl' | '2xl' | 'full'  // This creates a union type
}

export const Container: React.FC<ContainerProps> = ({
  children,
  className = '',
  maxWidth = 'xl'  // Default to 'xl' instead of '7xl' since that's not in the union
}) => {
  ...
  const maxWidthClasses = {
    ...
    '2xl': 'max-w-7xl',
    'full': 'max-w-full'
  } as const  // 'as const' makes this object read-only with literal types
