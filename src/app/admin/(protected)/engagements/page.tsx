...
export default function AdminEngagementsPage() {
  ...
  const getStatusBadge = (engagement: any) => {
    ...
    if (!engagement.messagingAllowed) {
      return <span className="px-2 py-1 bg-yellow-100 text-yellow-800 rounded-full text-xs">Feedback Required</span>
    }
                        ...
                        <div className="flex items-center">
                          <div className="w-24 bg-gray-200 rounded-full h-2 mr-2">
                            <div
                              ...
                              style={{ width: `${eng.currentProgress}%` }}
                            />
                          </div>
                          <span className="text-sm text-gray-600">{eng.currentProgress}%</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        {getStatusBadge(eng)}
